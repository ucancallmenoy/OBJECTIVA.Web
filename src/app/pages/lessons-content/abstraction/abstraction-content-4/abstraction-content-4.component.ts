...
@Component({
  selector: 'app-abstraction-content-4',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './abstraction-content-4.component.html',
  styleUrl: './abstraction-content-4.component.css'
})
export class AbstractionContent4Component {
