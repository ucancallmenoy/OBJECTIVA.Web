...
@Component({
  selector: 'app-polymorphism-content-3',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './polymorphism-content-3.component.html',
  styleUrl: './polymorphism-content-3.component.css'
})
export class PolymorphismContent3Component {
