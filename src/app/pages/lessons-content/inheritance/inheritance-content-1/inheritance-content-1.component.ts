...
@Component({
  selector: 'app-inheritance-content-1',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './inheritance-content-1.component.html',
  styleUrl: './inheritance-content-1.component.css'
})
export class InheritanceContent1Component {
